...
import (
	...
	c "github.com/cincout/mssfcore/context"
...
func (s *rpcServer) Register() error {
	...
	logs.DefaultLog.Informational("Registering node: %s", node.Id)
...
func (s *rpcServer) Deregister() error {
	...
	logs.DefaultLog.Informational("Deregistering node: %s", node.Id)
	...
	for sb, subs := range s.subscribers {
		for _, sub := range subs {
			logs.DefaultLog.Informational("Unsubscribing from topic: %s", sub.Topic())
			sub.Unsubscribe()
		}
...
func (s *rpcServer) Start() error {
	...
	logs.DefaultLog.Informational("Listening on %s", ts.Addr())
	s.Lock()
